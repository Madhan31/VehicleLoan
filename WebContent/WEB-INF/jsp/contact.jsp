...
<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <p><span class="glyphicon glyphicon-phone"></span>Phone: +0422 647 1113</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: i2iloan@gmail.com</p>
    </div>
    <div class="col-md-8">
      <div class="row">
  ...
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">Madhan</a></li>
    <li><a data-toggle="tab" href="#menu1">Vicky</a></li>

  </ul>

  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <h2>Madhan, Founder</h2>
