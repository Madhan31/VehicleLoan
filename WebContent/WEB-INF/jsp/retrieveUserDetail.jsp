    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
    	...
    	<div class="jumbotron text-center" style="padding-top: 2px; padding-bottom: 13px;">
            <h1><small>User Loan Detail</small></h1>
            </div>
               <div class = "container">
            ...
            <table class="table">
                ...
                <c:forEach items = "${loanDetails}" var = "loanDetail">
                    <tr class = "info">
                        ...
                        <td><a href = "retrieveUserLoanBalanceDetail?loanId=${loanDetail.loanId}"> view balance</a></td>
                        <td><a href = "retrieveUserPaymentDetail?loanId=${loanDetail.loanId}"> view payment detail</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
